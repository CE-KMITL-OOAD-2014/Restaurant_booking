  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <p><a href="http://getbootstrap.com/examples/theme/#" class="btn btn-primary btn-lg" role="button">Learn more »</a></p>
      </div>
      ...
      <p>
        <a href="http://getbootstrap.com/examples/theme/#">Inbox <span class="badge">42</span></a>
      </p>
      <ul class="nav nav-pills">
        <li class="active"><a href="http://getbootstrap.com/examples/theme/#">Home <span class="badge">42</span></a></li>
        <li><a href="http://getbootstrap.com/examples/theme/#">Profile</a></li>
        <li><a href="http://getbootstrap.com/examples/theme/#">Messages <span class="badge">3</span></a></li>
      </ul>
      ...
      <div class="dropdown theme-dropdown clearfix">
        <a id="dropdownMenu1" href="http://getbootstrap.com/examples/theme/#" role="button" class="sr-only dropdown-toggle" data-toggle="dropdown">Dropdown <span class="caret"></span></a>
        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
          <li class="active" role="presentation"><a role="menuitem" tabindex="-1" href="http://getbootstrap.com/examples/theme/#">Action</a></li>
          <li role="presentation"><a role="menuitem" tabindex="-1" href="http://getbootstrap.com/examples/theme/#">Another action</a></li>
          <li role="presentation"><a role="menuitem" tabindex="-1" href="http://getbootstrap.com/examples/theme/#">Something else here</a></li>
          <li role="presentation" class="divider"></li>
          <li role="presentation"><a role="menuitem" tabindex="-1" href="http://getbootstrap.com/examples/theme/#">Separated link</a></li>
        </ul>
      </div>
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="http://getbootstrap.com/examples/theme/#">Home</a></li>
        <li><a href="http://getbootstrap.com/examples/theme/#">Profile</a></li>
        <li><a href="http://getbootstrap.com/examples/theme/#">Messages</a></li>
      </ul>
      <ul class="nav nav-pills">
        <li class="active"><a href="http://getbootstrap.com/examples/theme/#">Home</a></li>
        <li><a href="http://getbootstrap.com/examples/theme/#">Profile</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="list-group">
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item active">
              Cras justo odio
            </a>
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">Dapibus ac facilisis in</a>
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">Morbi leo risus</a>
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">Porta ac consectetur ac</a>
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">Vestibulum at eros</a>
          </div>
        </div><!-- /.col-sm-4 -->
        <div class="col-sm-4">
          <div class="list-group">
            ...
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">
              <h4 class="list-group-item-heading">List group item heading</h4>
              <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
            </a>
            <a href="http://getbootstrap.com/examples/theme/#" class="list-group-item">
    ...
    <script src="./home_files/ie10-viewport-bug-workaround.js"></script>
  

<div id="global-zeroclipboard-html-bridge" class="global-zeroclipboard-container" title="" style="position: absolute; left: 0px; top: -9999px; width: 15px; height: 15px; z-index: 999999999;" data-original-title="Copy to clipboard">      <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="global-zeroclipboard-flash-bridge" width="100%" height="100%">         <param name="movie" value="/assets/flash/ZeroClipboard.swf?noCache=1413390414950">         <param name="allowScriptAccess" value="sameDomain">         <param name="scale" value="exactfit">         <param name="loop" value="false">         <param name="menu" value="false">         <param name="quality" value="best">         <param name="bgcolor" value="#ffffff">         <param name="wmode" value="transparent">         <param name="flashvars" value="trustedOrigins=getbootstrap.com%2C%2F%2Fgetbootstrap.com%2Chttp%3A%2F%2Fgetbootstrap.com">         <embed src="/assets/flash/ZeroClipboard.swf?noCache=1413390414950" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="100%" height="100%" name="global-zeroclipboard-flash-bridge" allowscriptaccess="sameDomain" allowfullscreen="false" type="application/x-shockwave-flash" wmode="transparent" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="trustedOrigins=getbootstrap.com%2C%2F%2Fgetbootstrap.com%2Chttp%3A%2F%2Fgetbootstrap.com" scale="exactfit">                </object></div></body></html>